...
public class MemberController {
    ...
    @PutMapping
    public ResponseEntity<ApiResponse<MemberView>> updateMember(@RequestHeader("accessToken") String token,
        @RequestBody RequestMember requestMember) {
        memberUseCase.updateMemberInfo(UpdateQuery.toQuery(1L, requestMember));
